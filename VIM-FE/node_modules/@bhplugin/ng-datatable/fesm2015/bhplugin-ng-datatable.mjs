...
class NgDataTableComponent {
    ...
    initDeafultValues() {
        ...
        for (const item of this.columns || []) {
            const type = ((_a = item.type) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || 'string';
            item.type = type;
    ...
    setUniqueKey() {
        ...
        this.uniqueKey = (col === null || col === void 0 ? void 0 : col.field) || '';
    }
    maxPage() {
    ...
    filterRows() {
        var _a, _b;
        let rows = this.rows || [];
        (_a = this.columns) === null || _a === void 0 ? void 0 : _a.forEach((d) => {
                ...
                if (d.type === 'string') {
                    if (d.condition === 'contain') {
                        rows = rows.filter((item) => {
                            var _a;
                            const val = (_a = d.field) === null || _a === void 0 ? void 0 : _a.split('.').reduce((obj, key) => obj === null || obj === void 0 ? void 0 : obj[key], item);
                            return val === null || val === void 0 ? void 0 : val.toString().toLowerCase().includes(d.value.toLowerCase());
                        });
                    }
                        ...
                        rows = rows.filter((item) => {
                            var _a;
                            const val = (_a = d.field) === null || _a === void 0 ? void 0 : _a.split('.').reduce((obj, key) => obj === null || obj === void 0 ? void 0 : obj[key], item);
                            return (val === null || val === void 0 ? void 0 : val.toString().toLowerCase()) === d.value.toLowerCase();
                        });
                    }
                        ...
                        rows = rows.filter((item) => {
                            var _a;
                            const val = (_a = d.field) === null || _a === void 0 ? void 0 : _a.split('.').reduce((obj, key) => obj === null || obj === void 0 ? void 0 : obj[key], item);
                            return (val === null || val === void 0 ? void 0 : val.toString().toLowerCase().indexOf(d.value.toLowerCase())) === 0;
                        });
                    }
                        ...
                        rows = rows.filter((item) => {
                            var _a;
                            const val = (_a = d.field) === null || _a === void 0 ? void 0 : _a.split('.').reduce((obj, key) => obj === null || obj === void 0 ? void 0 : obj[key], item);
                            return ((val === null || val === void 0 ? void 0 : val.toString().toLowerCase().substr(d.value.length * -1)) === d.value.toLowerCase());
                        });
                    }
                }
                // number filters
        ...
        if (this.currentSearch && rows.length) {
            ...
            for (let j = 0; j < rows.length; j++) {
                for (let i = 0; i < keys.length; i++) {
                    if ((_b = this.cellValue(rows[j], keys[i])) === null || _b === void 0 ? void 0 : _b.toString().toLowerCase().includes(this.currentSearch.toLowerCase())) {
                        final.push(rows[j]);
                        break;
                    }
                }
        ...
        rows.sort((a, b) => {
            var _a, _b;
            const valA = (_a = this.currentSortColumn) === null || _a === void 0 ? void 0 : _a.split('.').reduce((obj, key) => obj === null || obj === void 0 ? void 0 : obj[key], a);
            const valB = (_b = this.currentSortColumn) === null || _b === void 0 ? void 0 : _b.split('.').reduce((obj, key) => obj === null || obj === void 0 ? void 0 : obj[key], b);
            return collator.compare(valA, valB) * sortOrder;
        });
        this.filterRowCount = rows.length || 0;
        const result = rows.slice(this.offset() - 1, this.limit());
    ...
    checkIfAllSelected() {
        ...
        setTimeout(() => {
            var _a, _b;
            (_a = this.header1) === null || _a === void 0 ? void 0 : _a.checkboxChange();
            if (this.cloneHeaderInFooter) {
                (_b = this.header2) === null || _b === void 0 ? void 0 : _b.checkboxChange();
            }
        });
    }
    // columns filter
    ...
    cellValue(item, field = '') {
        return field === null || field === void 0 ? void 0 : field.split('.').reduce((obj, key) => obj === null || obj === void 0 ? void 0 : obj[key], item);
    }
    dateFormat(date) {
        try {
            if (!date) {
