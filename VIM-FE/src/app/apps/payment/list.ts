            ...
            .subscribe((data: any) => {
                if (data) {
                    ...
                    this.items = data.filter(item =>
                        item.numLevel == 6 &&
                        item.txtLevel === 'SIXTH' &&
                        (item.txtStatus6 === 'Pending' || item.txtStatus6 === 'Hold') &&
                        item.txtStatus6 !== 'Approved'
                    );
                    ...
                    // @ts-ignore
                    this.isPaymentHead = user.cfgTblRole?.txtRoleName === 'PAYMENT_HEAD';
            ...
            this.saleOrderService.searchSaleInvoice(this.dteFrom, this.dteTo).subscribe((data: any) => {
                if (data) {
                    ...
                    if (this.status === 'Unhold') {
                        // @ts-ignore
                        this.slsTblSaleOrder.txtStatus6 = 'Pending';
                        ...
                        // @ts-ignore
                        this.slsTblSaleOrder.txtStatus6 = 'cancel';
                       ...
                       // this.slsTblSaleOrder.txtStatus3 = 'Pending';
                        // @ts-ignore
                        this.slsTblSaleOrder.numLevel = 5;
                        // @ts-ignore
                        this.slsTblSaleOrder.txtLevel = 'FIFTH';
                        // @ts-ignore
                        this.slsTblSaleOrder.txtStatus5 = 'Pending';

                        // @ts-ignore
                        this.slsTblSaleOrder.txtStatus6 = 'Send Back';
                        ...
                        // @ts-ignore
                        this.slsTblSaleOrder.txtStatus6 = this.status;
    ...
    loadPermissionRoles(roleId: number | undefined, userId: number): void {
        ...
        this.menuService.getAllSubMenuRoles(roleId, userId).subscribe({
            next: (data) => {
                ...
                const filterCriteria = 'Payment Approval';
