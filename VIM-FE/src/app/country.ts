...
export class CountryComponent implements OnInit{
    ...
    constructor(public fb: FormBuilder,private notificationService:NotificationService) {
    }
    ...
    ngOnInit(): void {
        this.form4 = this.fb.group({
            ...
            zip: ['', [Validators.required, Validators.pattern('^[0-9]{5}$')]],  // Example zip validation
         //   isTerms: [false, Validators.requiredTrue]  // Checkbox validation
        });
    }
    ...
    submitForm4() {
        ...
        if (this.form4.valid) {
            ...
            this.notificationService.showMessage('Form submitted successfully.');
        }
    }
