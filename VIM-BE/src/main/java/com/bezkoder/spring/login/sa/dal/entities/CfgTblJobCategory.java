...
/**
 * The persistent class for the cfg_tbl_jobCategory database table.
 * 
 */
@Entity
@Table(name="cfg_tbl_jobCategory")
@NamedQuery(name="CfgTblJobCategory.findAll", query="SELECT c FROM CfgTblJobCategory c")
public class CfgTblJobCategory implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	@Column(name="ser_jobCategory_id")
	private Integer serJobCategoryId;
	...
	@Column(name="ser_parent_jobCategory_id")
	private Integer serParentJobCategoryId;
	...
	public CfgTblJobCategory() {
	}

	public Integer getSerJobCategoryId() {
		return this.serJobCategoryId;
	}

	public void setSerJobCategoryId(Integer serJobCategoryId) {
		this.serJobCategoryId = serJobCategoryId;
	}
	...
	public Integer getSerParentJobCategoryId() {
		return this.serParentJobCategoryId;
	}

	public void setSerParentJobCategoryId(Integer serParentJobCategoryId) {
		this.serParentJobCategoryId = serParentJobCategoryId;
	}
