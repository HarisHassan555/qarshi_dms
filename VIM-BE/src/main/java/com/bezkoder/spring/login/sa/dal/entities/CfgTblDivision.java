...
/**
 * The persistent class for the cfg_tbl_division database table.
 * 
 */
@Entity
@Table(name="cfg_tbl_division")
@NamedQuery(name="CfgTblDivision.findAll", query="SELECT c FROM CfgTblDivision c")
public class CfgTblDivision implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="CFG_TBL_DIVISION_SERDIVISIONID_GENERATOR", sequenceName="cfg_tbl_division_seq")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="CFG_TBL_DIVISION_SERDIVISIONID_GENERATOR")
	@Column(name="ser_division_id")
	private Integer serDivisionId;
	...
	public CfgTblDivision() {
	}

	public Integer getSerDivisionId() {
		return this.serDivisionId;
	}

	public void setSerDivisionId(Integer serDivisionId) {
		this.serDivisionId = serDivisionId;
	}
