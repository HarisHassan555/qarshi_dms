...
/**
 * The persistent class for the cfg_tbl_inco_terms database table.
 * 
 */
@Entity
@Table(name="cfg_tbl_inco_terms")
@NamedQuery(name="CfgTblIncoTerm.findAll", query="SELECT c FROM CfgTblIncoTerm c")
public class CfgTblIncoTerm implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="CFG_TBL_INCO_TERMS_SERINCOTERMSID_GENERATOR", sequenceName="cfg_tbl_inco_terms_seq")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="CFG_TBL_INCO_TERMS_SERINCOTERMSID_GENERATOR")
	@Column(name="ser_inco_terms_id")
	private Integer serIncoTermsId;
	...
	public CfgTblIncoTerm() {
	}

	public Integer getSerIncoTermsId() {
		return this.serIncoTermsId;
	}

	public void setSerIncoTermsId(Integer serIncoTermsId) {
		this.serIncoTermsId = serIncoTermsId;
	}
