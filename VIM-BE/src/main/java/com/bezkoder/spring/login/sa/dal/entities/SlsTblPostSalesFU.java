 ...
 */
@Entity
@Table(name = "sls_tbl_post_sale_follow_up")
@NamedQuery(name = "SlsTblPostSalesFU.findAll", query = "SELECT s FROM SlsTblPostSalesFU s")
public class SlsTblPostSalesFU implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SlsTblPostSalesFU_ser_work_order_id_seq")
	@SequenceGenerator(name = "SlsTblPostSalesFU_ser_work_order_id_seq", sequenceName = "SlsTblPostSalesFU_ser_work_order_id_seq", initialValue = 01, allocationSize = 1)
	@Column(name = "ser_post_sale_fu_id")
	private Integer serPostSalesFUId;
	...
	public Integer getSerPostSalesFUId() {
		return serPostSalesFUId;
	}

	public void setSerPostSalesFUId(Integer serPostSalesFUId) {
		this.serPostSalesFUId = serPostSalesFUId;
	}
	...
	@Column(name = "txt_sscQ1")
	private String txtSSCQ1;
	...
	public String getTxtSSCQ1() {
		return txtSSCQ1;
	}

	public void setTxtSSCQ1(String txtSSCQ1) {
		this.txtSSCQ1 = txtSSCQ1;
	}
