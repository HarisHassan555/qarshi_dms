...
/**
 * The persistent class for the cfg_tbl_payment_terms database table.
 * 
 */
@Entity
@Table(name="cfg_tbl_payment_terms")
@NamedQuery(name="CfgTblPaymentTerm.findAll", query="SELECT c FROM CfgTblPaymentTerm c")
public class CfgTblPaymentTerm implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="CFG_TBL_PAYMENT_TERMS_SERPAYMENTTERMSID_GENERATOR", sequenceName="cfg_tbl_payment_terms_seq")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="CFG_TBL_PAYMENT_TERMS_SERPAYMENTTERMSID_GENERATOR")
	@Column(name="ser_payment_terms_id")
	private Integer serPaymentTermsId;
	...
	public CfgTblPaymentTerm() {
	}

	public Integer getSerPaymentTermsId() {
		return this.serPaymentTermsId;
	}

	public void setSerPaymentTermsId(Integer serPaymentTermsId) {
		this.serPaymentTermsId = serPaymentTermsId;
	}
