 ...
 */
@Entity
@Table(name = "sls_tbl_maintinance_follow_up")
@NamedQuery(name = "SlsTblMaintinanceFU.findAll", query = "SELECT s FROM SlsTblMaintinanceFU s")
public class SlsTblMaintinanceFU implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SlsTblMaintinanceFU_ser_maintinance_id_seq")
	@SequenceGenerator(name = "SlsTblMaintinanceFU_ser_maintinance_id_seq", sequenceName = "SlsTblMaintinanceFU_ser_maintinance_id_seq", initialValue = 01, allocationSize = 1)
	@Column(name = "ser_maintinance_fu_id")
	private Integer serMaintinanceFUId;
	...
	public Integer getSerMaintinanceFUId() {
		return serMaintinanceFUId;
	}

	public void setSerMaintinanceFUId(Integer serMaintinanceFUId) {
		this.serMaintinanceFUId = serMaintinanceFUId;
	}
