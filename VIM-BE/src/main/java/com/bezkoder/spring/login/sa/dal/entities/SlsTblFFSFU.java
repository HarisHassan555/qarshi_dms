 ...
 */
@Entity
@Table(name = "sls_tbl_FFS_follow_up")
@NamedQuery(name = "SlsTblFFSFU.findAll", query = "SELECT s FROM SlsTblFFSFU s")
public class SlsTblFFSFU implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SlsTblFFSFU_ser_FFS_id_seq")
	@SequenceGenerator(name = "SlsTblFFSFU_ser_FFS_id_seq", sequenceName = "SlsTblFFSFU_ser_FFS_id_seq", initialValue = 01, allocationSize = 1)
	@Column(name = "ser_FFS_fu_id")
	private Integer serFFSFUId;
	
	/*@Column(name = "serWorkOrderId")
	private String serWorkOrderId;*/
	...
	public Integer getSerFFSFUId() {
		return serFFSFUId;
	}

	public void setSerFFSFUId(Integer serFFSFUId) {
		this.serFFSFUId = serFFSFUId;
	}
