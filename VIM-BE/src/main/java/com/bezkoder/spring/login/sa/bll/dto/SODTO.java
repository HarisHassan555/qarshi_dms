...
public class SODTO {
	...
	public String toString() {
		return "SODTO [txtOrderNO=" + txtOrderNO + ", txtDocType=" + txtDocType + ", txtPurchaseNo=" + txtPurchaseNo
				...
				+ ", txtDeliveryPartNo=" + txtDeliveryPartNo + ", txtDCNo=" + txtDCNo + ", txtInvoiceNo=" + txtInvoiceNo
				+ ", txtDealer=" + txtDealer + ", txtCustomer=" + txtCustomer + ", txtDealerName=" + txtDealerName
				+ ", txtCustomerName=" + txtCustomerName + ", txtPhone=" + txtPhone + ", txtCNIC=" + txtCNIC
				+ ", txtCity=" + txtCity + ", level=" + level + ", txtDivision=" + txtDivision
				+ ", txtPmndistChanterms=" + txtPmndistChanterms + ", txtItemNo=" + txtItemNo + ", numQty=" + numQty
				+ ", lstIds=" + lstIds + ", lstSchedule=" + lstSchedule + ", lstDetail=" + lstDetail + ", txtPsoNo="
				+ txtPsoNo + ", txtDoDoc=" + txtDoDoc + ", txtChassis=" + txtChassis + ", txtEngine=" + txtEngine
				+ ", blnFlag=" + blnFlag + ", txtReason=" + txtReason + "]";
	}
